...
public class PlayerHealthSnow : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (!gameObject.GetComponent<PlayerMovementSnow>().Grounded())
            {
                DieJump();
            }
            else
    ...
    void Die()
    {
        ...
        gameObject.GetComponent<PlayerMovementSnow>().IsDead = true;
